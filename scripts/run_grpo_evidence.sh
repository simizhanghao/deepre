...
MODEL_PATH=${MODEL_PATH:-$REPO/outputs/00_sft_v1_merged}
TOOL_CFG=$REPO/configs/rl/candidate_bm25_tool.yaml
AGENT_CFG=$REPO/configs/rl/eca_agent_loop.yaml
REWARD_PATH=$REPO/src/rl/rewards_evidence.py
OUT_DIR=${OUT_DIR:-$REPO/outputs/rl/01_ckpt_grpo_evidence_fsdp}
STEPS=${STEPS:-500}
