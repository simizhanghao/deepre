...
2026-08-08 | phase3b2-resume15 | docker exec -d resume step15→50 after SIGTERM kill of client-attached exec | logs/grpo_sftv1_smoke_to50_resume15_* | running | rootcause: host docker exec SIGTERM → Ray INTENDED_USER_EXIT
